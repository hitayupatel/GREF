...
import com.example.hitayu.gref11.conversion.FileToDbConversion;
import com.example.hitayu.gref11.db.DataSource;
import com.example.hitayu.gref11.dialog.HelpDialog;
import com.example.hitayu.gref11.fragment.AboutFragment;
import com.example.hitayu.gref11.fragment.ActionbarFragment;
import com.example.hitayu.gref11.fragment.AddCardFragment;
import com.example.hitayu.gref11.fragment.CardSetsFragment;
import com.example.hitayu.gref11.fragment.SetupFragment;
import com.example.hitayu.gref11.model.CardSet;
import com.example.hitayu.gref11.pager.CardsPager;

public class PracticeWordsActivity extends FragmentActivity implements ActionBusListener, AppConstants {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMainApplication.registerAction(this, ACTION_SHOW_CARD_SETS, ACTION_SHOW_CARDS,
                ACTION_SHOW_HELP, ACTION_SHOW_SETUP, ACTION_SHOW_ABOUT,
                ACTION_GET_EXTERNAL_CARD_SETS, ACTION_SET_HELP_CONTEXT, ACTION_SHOW_ADD_CARD,
                ACTION_ADD_CARD_SET, ACTION_FONT_SIZE_CHANGE, ACTION_SEND_FEEDBACK,
        ...
        boolean runConversion = sharedPreferences.getBoolean(PREFERENCE_RUN_CONVERSION,
                PREFERENCE_RUN_CONVERSION_DEFAULT);
		 ...
		 */
        int fontSizePreference = sharedPreferences.getInt(PREFERENCE_FONT_SIZE,
                PREFERENCE_NORMAL_FONT_SIZE);
